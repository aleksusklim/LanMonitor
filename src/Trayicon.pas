...
//    function ModifyIcon: boolean;
  ...
  published
    ...
    procedure Balloon(Text:string='';Caption:string='');
  end;
...
begin
  ...
  begin
    ...
    uFlags := NIF_MESSAGE + NIF_ICON + NIF_TIP + $10;
    hIcon := fIcon.Handle;
    StrPCopy(szTip, fToolTip);
    StrPCopy(szInfo, fBallonText);
    StrPCopy(szInfoTitle, fBallonTitle);
...
procedure TTrayIcon.Balloon(Text:string='';Caption:string='');
begin
  fBallonText:=Copy(Text,1,255);
  fBallonTitle:=Caption;
  ModifyIcon;
end;
